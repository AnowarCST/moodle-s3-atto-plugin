...
$plugin->requires  = 2019111200;        // Requires Moodle 2.7 or higher, when Atto was added to core.
$plugin->component = 'atto_s3';  // Full name of the plugin (used for diagnostics).
