...
$string['pluginname'] = 's3 video';
$string['uploading'] = 'Uploading, please wait...';
$string['privacy:metadata']      = 'The s3 video plugin for Atto does not store personal data.';

// Strings used in import.php.
$string['transformationfailed'] = 'Error';
...
$string['settings'] = 's3 video settings';
...
$string['s3_account'] = 's3 account';
$string['s3_account_desc'] = 's3 account number';
$string['s3_player'] = 's3 player';
$string['s3_player_desc'] = 's3 player id';
